...
.btn-import {
    ...
    color: white;
    margin-bottom: 10px; /* Añade margen inferior para espacio adicional */
}
...
.informacion_producto {
    width: 50%; /* Aproximadamente la mitad del contenedor, similar a col-6 */
    margin-bottom: 1rem; /* Espaciado en la parte inferior, similar a mb-4 */
}
