...
function agregarModal_marketplace(id) {
    $.ajax({
        type: "GET", // Usar GET ya que la API espera un parámetro en la URL
        url: `https://new.imporsuitpro.com/marketplace/obtener_producto/${id}`,
        dataType: 'json',
            ...
            if (response && response.producto) {
                ...
                if ($('.informacion_producto').length > 0) {
                    ...
                    $('.informacion_producto').html(`
                        ...
                        <p class="texto_modal"><strong>Código del Producto:</strong> ${data.codigo}</p>
                        <p class="texto_modal"><strong>Nombre Producto:</strong> ${data.nombre}</p>
                        <p class="texto_modal"><strong>Precio Proveedor:</strong> $${data.precio_proveedor}</p>
                        <p class="texto_modal"><strong>Precio Sugerido:</strong> $${data.precio_sugerido}</p>
                        <p class="texto_modal"><strong>Stock:</strong> <span class="text-success"><strong>${data.stock}</strong></span></p>
