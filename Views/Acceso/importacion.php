...
<div class="full-screen-container">
    <div class="custom-container-fluid mt-4">
        ...
        <div class="download-button-container">
            <a href="https://tiendas.imporsuitpro.com/plantilla/plantilla_plataformas.xlsx" class="btn btn-success download-button">Descargar Plantilla</a>
        </div>
...
<script>
    $(document).ready(function() {
        $('#uploadForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?php echo SERVERURL; ?>Usuarios/importarExcelPlataformas', // Ruta del controlador que manejará el archivo
                type: 'POST',
                data: formData,
                ...
                success: function(response) {
                    if (response.status == 500) {
                        toastr.error(
                            "LOS USUARIOS SE AGREGARON CORRECTAMENTE",
                            "NOTIFICACIÓN", {
                                positionClass: "toast-bottom-center"
                            }
                        );
                    } else if (response.status == 200) {
                        toastr.success("USUARIOS NO SE AGREGADON CORRECTAMENTE", "NOTIFICACIÓN", {
                            positionClass: "toast-bottom-center",
                        });
