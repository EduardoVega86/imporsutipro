...
<?php require_once './Views/Acceso/css/recoveryAcceso_style.php'; ?>
    ...
    <div class="d-flex flex-column" style="width: 700px;">
        ...
        <div class="container">
            ...
            <div class="hidden" id="cambiar_contrasena">
                ...
                <button type="button" class="btn btn-primary w-100" id="btnCambiar_contrasena"><i
                            class="fa-solid fa-key"></i> Cambiar contraseña
                </button>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            const token = url_1.substring(url_1.lastIndexOf('/') + 1);

            // Construir el objeto JSON con el token
