...
<div class="modal fade" id="vista_detalle_novedad" tabindex="-1" aria-labelledby="vista_detalle_novedadLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="vista_detalle_novedadLabel"><i class="fas fa-edit"></i> Novedad</h5>
