        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-info text-center">
                    Te enviaremos a tu mensaje a este correo:<span style="font-weight: 900"> <?php echo $_SESSION["user"] ?></span> con un código de seguridad de 6 dígitos, recuerda que el código vence en 5 minutos.
                </div>
