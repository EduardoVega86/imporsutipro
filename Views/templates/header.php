        ...
        <div class="menu">
            ...
            <?php if ($_SESSION['cargo'] != 35) { ?>
                ...
                <div class="submenu" id="submenu01">
                    ...
                    <a href="<?php echo SERVERURL ?>Productos/proveedores_pro"><i class='bx bx-briefcase menu-icon'></i> <span class="menu-text">Proveedores</span></a>
                </div>
                ...
                <div class="submenu" id="submenu2">
                    ...
                    ?>
                        <a href="<?php echo SERVERURL ?>pedidos/guias2"><i class='bx bx-archive menu-icon'></i> <span class="menu-text">Guías</span></a>
