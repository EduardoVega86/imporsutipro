...
if ($check_cofiguraciones_stmt->num_rows > 0) {
    ...
    file_put_contents('debug_log.txt', "Error: No se encontró configuración con id: " . $business_phone_id . "\n", FILE_APPEND);
    echo json_encode(["status" => "error", "message" => "No se encontró la configuración para id: " . $business_phone_id]);
    exit;
}
/* consultar id_configuracion, id_platafirma, token y id_whatsapp desde BD con el business_phone_id  */
