...
class MarketplaceModel extends Query
{
    ...
    public function obtenerProveedoresConProductosCategorias()
    {
        ...
        $sql = "SELECT p.*, 
                       ...
                       GROUP_CONCAT(DISTINCT l.nombre_linea ORDER BY l.nombre_linea SEPARATOR ', ') AS categorias
                FROM plataformas p
    ...
    public function obtener_productos(
        ...
        $sql = "SELECT DISTINCT 
                ...
                LEFT JOIN lineas_productos lp
                    ON p.id_linea_producto = lp.id_linea
                WHERE 
                    p.drogshipin = 1
