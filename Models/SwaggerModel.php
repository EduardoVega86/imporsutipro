...
class SwaggerModel extends Query
{
    ...
    public function guardarImagenAdicionalProductosTienda($uuid, $imagen, $num_imagen, $id_producto)
    {
        try {
            // 1. Verificar si existe usuario con ese UUID
            $usuario = $this->accesoModel->getUserByUUID($uuid);
            ...
            // 4. Llamar al método de productos para subir y guardar la imagen
            return $this->productosModel->guardar_imagenAdicional_productosTienda(
                $num_imagen,
                $imagen,
                $id_producto,
                $idPlataforma
            ...
            return [
                'status'  => 500,
                'message' => 'Error interno al subir la imagen adicional en tabla imagens_adicionales_productoTienda',
                'error'   => $e->getMessage()
            ];
        }
    }
    ...
    public function cargarEtiquetas($uuid, $id_plataforma)
    {
        try {
            // 1) Verificar si existe usuario con ese UUID
            $usuario = $this->accesoModel->getUserByUUID($uuid);
            ...
            // 3) Llamamos al modelo de productos para listar las bodegas
            return $this->productosModel->cargarEtiquetas($id_plataforma);
        } catch (Exception $e) {
            return [
                'status'  => 500,
                'message' => 'Error interno al listar etiquetas.',
                'error'   => $e->getMessage()
            ];
        }
    }
    ...
    public function agregarProducto(
        ...
        try {
            ...
            // 4. Llamar al método de productos para insertar la categoría
            return $this->productosModel->agregarProducto(
                $codigo_producto,
                $nombre_producto,
                $descripcion_producto,
                $id_linea_producto,
    ...
    public function editarProducto(
        ...
        try {
            ...
            // 4. Llamar al método de productos para insertar la categoría
            return $this->productosModel->editarProducto(
                $id_producto,
                $codigo_producto,
                $nombre_producto,
                $descripcion_producto,
            ...
            return [
                'status'  => 500,
                'message' => 'Error interno al editar el producto',
                'error'   => $e->getMessage()
            ];
        }
    }
