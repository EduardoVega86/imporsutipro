...
class InventariosModel extends Query
{
    ...
    public function despacho_guia($num_guia, $plataforma)
    {
        ...
        $sql_plataforma_bodega = "SELECT b.id_plataforma FROM `detalle_fact_cot` dfc, inventario_bodegas  ib, bodega b where id_factura=$id_factura and dfc.id_inventario=ib.id_inventario GROUP by bodega";
