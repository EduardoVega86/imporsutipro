...
class InventariosModel extends Query
{
    ...
    public function ingreso_producto($sku, $plataforma)
    {

        $response = $this->initialResponse();

        $sql_producto = "SELECT * FROM inventario_bodegas ib, productos p WHERE sku = '$sku' and ib.id_plataforma = $plataforma and p.id_producto=ib.id_producto";
       //echo $sql_producto;
        //echo $sql_factura;
        $producto = $this->select($sql_producto);
      //  $producto = $this->select($sql_producto);
